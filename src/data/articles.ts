...
export const articles: Article[] = [
  {
    ...
    sourceUrl: "#",
    description:
      "読む、試す、記録する、商品化するまでの基本ルートをnote読者向けに整理する予定の記事候補です。",
    status: "sample",
    tags: ["AIノート", "導入", "note"],
    funnelStage: "learn",
  ...
  },
  {
    ...
    sourceUrl: "#",
    description:
      "調査、要約、比較、記事化に使えるプロンプトを無料キットと連動して紹介する予定の記事候補です。",
    status: "sample",
  ...
  },
  {
    ...
    sourceUrl: "#",
    description:
      "技術者向けに、AIメモをGitHub管理し、記事とテンプレートへ展開する方法をまとめる予定です。",
    status: "planned",
  ...
  },
  {
    ...
    sourceUrl: "#",
    description:
      "English readers向けに、AI note workflows and product funnelsの全体像を紹介する予定です。",
    status: "planned",
  ...
  },
  {
    ...
    funnelStage: "nurture",
    relatedProductIds: ["booth-template-pack", "automation-design-pack"],
    isPlaceholder: false,
  ...
  },
  {
    ...
    sourceUrl: "#",
    description:
      "録音、要約、アクション整理を、チームで使えるAIノートに落とし込む予定の記事候補です。",
    status: "sample",
  ...
  },
  {
    ...
    title: "noteから買い切り商品までをつなぐAI発信導線の設計",
    source: "site",
    sourceUrl: "/products",
    description:
      "無料DL、有料note、BOOTH商品をどの順番で置くかを解説します。",
    status: "published",
    tags: ["導線設計", "買い切り", "商品設計"],
    funnelStage: "buy",
    relatedProductIds: ["automation-design-pack"],
    isPlaceholder: false,
