...
const emailReplyUseCase: AiUseCase = {
  ...
  outputExample:
    "相手の要件: 打ち合わせ日程の調整、事前資料の共有。確認が必要: 資料の最終確認が予定どおり終わるか。返信文: ご連絡ありがとうございます。打ち合わせは木曜15時でしたら対応可能です。前回の資料は現在最終確認中のため、水曜午前を目安にお送りします。木曜15時で問題なぇご確認いただけますでしょうか。",
  improvementPrompt:
